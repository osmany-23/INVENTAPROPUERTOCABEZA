                                    ...
                                    return (
                                        <tr className="align-middle">
                                            ...
                                            <td>
                                                ...
                                                {item.payment_type === 2 &&
                                                    getFormattedMessage("payment-method.filter.cheque.label")}
                                                {item.payment_type === 3 &&
                                                    getFormattedMessage('payment-method.filter.bank-transfer.label')}
                                                {item.payment_type === 4 &&
                                                    getFormattedMessage("payment-method.filter.other.label")}
                                            </td>
                                            <td>
                                                <Button
                                                    type="button"
