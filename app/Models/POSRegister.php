...
class POSRegister extends BaseModel implements JsonResourceful
{
    ...
    public function prepareAttributes(): array
    {
        $fields = [
            ...
            'credit_collections_total' => (float) ($this->credit_collections_total ?? 0),
            'credit_collections_cash' => (float) ($this->credit_collections_cash ?? 0),
            'credit_collections_cheque' => (float) ($this->credit_collections_cheque ?? 0),
            'credit_collections_bank_transfer' => (float) ($this->credit_collections_bank_transfer ?? 0),
            'credit_collections_other' => (float) ($this->credit_collections_other ?? 0),
            'credit_interest_amount' => (float) ($this->credit_interest_amount ?? 0),
            'gross_income_amount' => (float) ($this->gross_income_amount ?? 0),
            'notes' => $this->notes,
